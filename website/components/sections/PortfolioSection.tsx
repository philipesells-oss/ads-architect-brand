...
const row1 = [
  'Alternative Beach', 'The Barn Canggu', 'ASAI Spa & Café', 'Dom Restaurant',
  'Donna Ubud', 'Twelve Urban Café', 'REVĪVŌ Wellness Resort', 'Vitality Center',
  'The Loft', 'Tao Padel',
];
const row2 = [
  'Domo Industrias', 'Maria Curau Salon', 'Pescado', 'Inka Spa Ubud',
  'Sunday Kitchen', 'La Tribu', 'Ubuntu Bali', 'Signa Cafe', 'Ivy Cafe', 'Nutrio Restaurant',
];
const row3 = [
  'Chilli Beans Indonesia', 'Ubuntu Bali', 'Alternative Beach', 'The Barn Canggu',
  'ASAI Spa & Café', 'REVĪVŌ Wellness Resort', 'Domo Industrias', 'Maria Curau Salon',
  'Vitality Center', 'Sunday Kitchen',
];
...
export function PortfolioSection() {
  ...
  return (
    <section className="relative section-divider py-16 md:py-20 overflow-hidden">
      ...
      >
        <p className="overline mb-3">{t.portfolio.overline}</p>
